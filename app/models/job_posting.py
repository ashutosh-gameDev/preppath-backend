...
class JobPosting(Base, UUIDPKMixin, TimestampMixin):
    ...
    Notifications page's Jobs tab - distinct from ExamEvent (a milestone for
    an exam the student follows) and from Question/Test content entirely.
    Students set their own date_of_birth/qualification once (Profile) and
    ...
    # students) - null means relevant to everyone, same "unset = global"
    # convention as Exam.course_id.
